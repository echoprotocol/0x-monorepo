...
async function transferAssetAsync(
    ...
    switch (assetProxyId) {
        ...
        case AssetProxyId.ERC1155: {
            const [proxyId, assetAddress, tokenIds, tokenValues] = await devUtils.decodeERC1155AssetData.callAsync(assetData); // tslint:disable-line-no-unused-variable
        ...
        case AssetProxyId.MultiAsset: {
            ...
            for (const i of _.times(amounts.length)) {
                ...
                await transferAssetAsync(fromAddress, toAddress, nestedAmount, _nestedAssetData, matchResults, devUtils);
            }
            break;
        }
        default:
