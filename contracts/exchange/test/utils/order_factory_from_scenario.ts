    ...
    public async generateOrderAsync(orderScenario: OrderScenario): Promise<Order> {
        ...
        switch (orderScenario.makerAssetDataScenario) {
            case AssetDataScenario.ERC20EighteenDecimals:
                makerAssetData = await this._devUtils.encodeERC20AssetData.callAsync(this._erc20EighteenDecimalTokenAddresses[0]);
                break;
            case AssetDataScenario.ERC20FiveDecimals:
                makerAssetData = await this._devUtils.encodeERC20AssetData.callAsync(this._erc20FiveDecimalTokenAddresses[0]);
                break;
            case AssetDataScenario.ERC721:
                makerAssetData = await this._devUtils.encodeERC721AssetData.callAsync(this._erc721TokenAddress, erc721MakerAssetIds[0]);
                break;
            case AssetDataScenario.ERC20ZeroDecimals:
                makerAssetData = await this._devUtils.encodeERC20AssetData.callAsync(this._erc20ZeroDecimalTokenAddresses[0]);
                break;
            ...
            case AssetDataScenario.MultiAssetERC20:
                makerAssetData = await this._devUtils.encodeMultiAssetData.callAsync(
                    ...
                    [
                        await this._devUtils.encodeERC20AssetData.callAsync(this._erc20EighteenDecimalTokenAddresses[0]),
        ...
        switch (orderScenario.takerAssetDataScenario) {
            case AssetDataScenario.ERC20EighteenDecimals:
                takerAssetData = await this._devUtils.encodeERC20AssetData.callAsync(this._erc20EighteenDecimalTokenAddresses[1]);
                break;
            case AssetDataScenario.ERC20FiveDecimals:
                takerAssetData = await this._devUtils.encodeERC20AssetData.callAsync(this._erc20FiveDecimalTokenAddresses[1]);
                break;
            case AssetDataScenario.ERC721:
                takerAssetData = await this._devUtils.encodeERC721AssetData.callAsync(this._erc721TokenAddress, erc721TakerAssetIds[0]);
                break;
            case AssetDataScenario.ERC20ZeroDecimals:
                takerAssetData = await this._devUtils.encodeERC20AssetData.callAsync(this._erc20ZeroDecimalTokenAddresses[1]);
                break;
            case AssetDataScenario.ERC1155Fungible:
            ...
            case AssetDataScenario.MultiAssetERC20:
                takerAssetData = await this._devUtils.encodeMultiAssetData.callAsync(
                    [ONE_UNITS_EIGHTEEN_DECIMALS, ONE_UNITS_FIVE_DECIMALS],
                    [
                        await this._devUtils.encodeERC20AssetData.callAsync(this._erc20EighteenDecimalTokenAddresses[1]),
        ...
        const feeFromScenario = async (
            ...
            switch (feeAssetDataScenario) {
                ...
                case FeeAssetDataScenario.ERC20EighteenDecimals:
                    return [feeAmount, await this._devUtils.encodeERC20AssetData.callAsync(erc20EighteenDecimalTokenAddress)];
                case FeeAssetDataScenario.ERC20FiveDecimals:
                    return [feeAmount, await this._devUtils.encodeERC20AssetData.callAsync(erc20FiveDecimalTokenAddress)];
                case FeeAssetDataScenario.ERC20ZeroDecimals:
                    return [feeAmount, await this._devUtils.encodeERC20AssetData.callAsync(erc20ZeroDecimalTokenAddress)];
                case FeeAssetDataScenario.ERC721:
                    return [feeAmount, await this._devUtils.encodeERC721AssetData.callAsync(this._erc721TokenAddress, erc721AssetId)];
