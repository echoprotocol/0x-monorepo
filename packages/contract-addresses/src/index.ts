...
const networkToAddresses: { [networkId: number]: ContractAddresses } = {
    ...
    3: {
        erc20Proxy: '0x01000000000000000000000000000000000001a4',
        erc721Proxy: '0x01000000000000000000000000000000000001a5',
        zrxToken: '0x01000000000000000000000000000000000001a6',
        etherToken: '0x01000000000000000000000000000000000001a7',
        webtcToken: '0x01000000000000000000000000000000000001a2',
        weethToken: '0x01000000000000000000000000000000000001a3',
        exchange: '0x01000000000000000000000000000000000001a8',
        assetProxyOwner: '0x01000000000000000000000000000000000001b3',
        forwarder: '0x01000000000000000000000000000000000001b0',
        orderValidator: '0x01000000000000000000000000000000000001b1',
        dutchAuction: '0x01000000000000000000000000000000000001b2',
        coordinatorRegistry: '0x01000000000000000000000000000000000001b4',
        coordinator: '0x01000000000000000000000000000000000001b5',
    },
    4: {
